...
rec {
  ...
  workspaceMembers = {
    "calibre-metadata-api" = rec {
      packageId = "calibre-metadata-api";
    ...
    "download-to-file" = rec {
      packageId = "download-to-file";
      build = internal.buildRustCrateWithFeatures {
        packageId = "download-to-file";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "axum-extra" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "form" "query" "tracing" ];
      };
      "axum-macros" = rec {
      ...
      "calibre-metadata-api" = rec {
        crateName = "calibre-metadata-api";
        version = "0.0.1";
        edition = "2024";
        crateBin = [
          {
        ...
        dependencies = [
          ...
          }
          {
            ...
            features = [ "signed" "private" ];
          }
          {
            name = "tower-http";
            packageId = "tower-http";
            features = [ "tracing" "trace" ];
          }
          {
            name = "tracing";
            packageId = "tracing";
      ...
      "calibreweb" = rec {
        crateName = "calibreweb";
        version = "0.1.0";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./calibreweb; };
        dependencies = [
          {
            name = "anyhow";
            packageId = "anyhow";
          ...
          }
          {
            name = "sqlx";
            packageId = "sqlx";
            features = [ "runtime-tokio" "tls-rustls" "sqlite" "macros" "uuid" "chrono" "rust_decimal" "sqlx-toml" "macros" "sqlx-toml" ];
          }
        ];
      ...
      "download-to-file" = rec {
        ...
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./examples/download-to-file; };
        dependencies = [
          {
            name = "anyhow";
            packageId = "anyhow";
      ...
      "reqwest 0.12.28" = rec {
        ...
        resolvedDefaultFeatures = [ "__rustls" "__rustls-ring" "__tls" "blocking" "charset" "default" "default-tls" "h2" "http2" "json" "rustls-tls" "rustls-tls-native-roots" "rustls-tls-native-roots-no-provider" "rustls-tls-webpki-roots" "rustls-tls-webpki-roots-no-provider" "system-proxy" ];
      };
      "reqwest 0.13.2" = rec {
        crateName = "reqwest";
        version = "0.13.2";
      ...
      "serde_qs" = rec {
        ...
        resolvedDefaultFeatures = [ "axum" "axum-framework" "default" "futures" "tracing" ];
      };
      ...
      "sqlx" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "b27b49de3bbaaf8101f47ad8ee5da0a20ff506aa";
          sha256 = "0lzdqnxslqfg6lw5aqjjprfk9053q2zp8yh8jlsbj489z0p5kpxn";
        };
        authors = [
      ...
      "windows-sys 0.59.0" = rec {
        ...
        resolvedDefaultFeatures = [ "Win32" "Win32_Foundation" "Win32_Security" "Win32_Storage" "Win32_Storage_FileSystem" "Win32_System" "Win32_System_Com" "Win32_System_Console" "Win32_UI" "Win32_UI_Shell" "default" ];
      };
