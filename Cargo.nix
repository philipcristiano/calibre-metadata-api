  ...
  internal = rec {
    ...
    crates = {
      ...
      "reqwest 0.13.1" = rec {
        ...
        resolvedDefaultFeatures = [ "__rustls" "__rustls-aws-lc-rs" "__tls" "blocking" "default-tls" "rustls" "webpki-roots" ];
      };
      "rfc6979" = rec {
        crateName = "rfc6979";
        version = "0.4.0";
      ...
      "sqlx" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "75bc0487eb661da811bb7a3c5d158f1bd463fef4";
          sha256 = "0cwg8q885mkjw1rgqmg7vli1bfzgcb2mnd1mnxqnb3k62svhm156";
        };
        authors = [
